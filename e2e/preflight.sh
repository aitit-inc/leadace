...
check_url "API Worker"        "http://localhost:$api_port/health"
check_url "MCP Worker"        "http://localhost:$mcp_port/.well-known/oauth-authorization-server"
check_url "Frontend dev"      "http://localhost:$frontend_port"
