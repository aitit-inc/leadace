...
{#if data.result.state === 'invalid'}
  <div class="min-h-screen bg-page">
    <div class="mx-auto max-w-2xl px-6 py-10">
      ...
      <h1 class="mt-10 font-display text-3xl font-semibold tracking-tight text-text">Preview unavailable</h1>
...
{:else if landing}
  {#if data.prospects.length > 0 || filterQ}
    <div class="border-b border-border bg-surface px-4 py-2">
      <div class="mx-auto flex max-w-2xl items-center gap-2 text-sm text-text-secondary">
