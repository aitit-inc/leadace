...
// Generated by /build-list at registration and frozen afterwards. Fields are
// all optional — a partially filled hypothesis is still useful (the LLM
// gracefully degrades).
...
export const prospects = pgTable('prospects', {
  ...
  // no-solicitation notice. NULL = provenance not recorded (CSV import, manual
